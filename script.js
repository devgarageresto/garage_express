...
function render(data) {
    ...
    for (const sectionName in data) {
        ...
        data[sectionName].forEach(item => {
            ...
            const imageSrc = (item.image && item.image.trim() !== "") ? item.image : placeholderLogo;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ${item.prices ? `<div class="multi-price">${item.prices.map(p => `
